...
Source0  : https://download.kde.org/stable/release-service/22.12.2/src/killbots-22.12.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/22.12.2/src/killbots-22.12.2.tar.xz.sig
...
%prep
%setup -q -n killbots-22.12.2
cd %{_builddir}/killbots-22.12.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1675655600
mkdir -p clr-build
pushd clr-build
