...
Version  : 23.08.5
Release  : 63
URL      : https://download.kde.org/stable/release-service/23.08.5/src/killbots-23.08.5.tar.xz
Source0  : https://download.kde.org/stable/release-service/23.08.5/src/killbots-23.08.5.tar.xz
Source1  : https://download.kde.org/stable/release-service/23.08.5/src/killbots-23.08.5.tar.xz.sig
...
%prep
%setup -q -n killbots-23.08.5
cd %{_builddir}/killbots-23.08.5
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1708408194
mkdir -p clr-build
pushd clr-build
