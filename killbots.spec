...
Version  : 19.12.2
Release  : 18
URL      : https://download.kde.org/stable/release-service/19.12.2/src/killbots-19.12.2.tar.xz
Source0  : https://download.kde.org/stable/release-service/19.12.2/src/killbots-19.12.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/19.12.2/src/killbots-19.12.2.tar.xz.sig
...
%prep
%setup -q -n killbots-19.12.2
cd %{_builddir}/killbots-19.12.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1581023298
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/killbots-19.12.2/COPYING %{buildroot}/usr/share/package-licenses/killbots/4cc77b90af91e615a64ae04893fdffa7939db84c
cp %{_builddir}/killbots-19.12.2/COPYING.DOC %{buildroot}/usr/share/package-licenses/killbots/bd75d59f9d7d9731bfabdc48ecd19e704d218e38
pushd clr-build
%make_install
popd
%find_lang killbots
