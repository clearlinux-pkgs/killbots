...
Version  : 22.08.0
Release  : 43
URL      : https://download.kde.org/stable/release-service/22.08.0/src/killbots-22.08.0.tar.xz
Source0  : https://download.kde.org/stable/release-service/22.08.0/src/killbots-22.08.0.tar.xz
...
%prep
%setup -q -n killbots-22.08.0
cd %{_builddir}/killbots-22.08.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1661549291
mkdir -p clr-build
pushd clr-build
