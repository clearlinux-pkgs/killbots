...
Version  : 24.02.2
Release  : 66
URL      : https://download.kde.org/stable/release-service/24.02.2/src/killbots-24.02.2.tar.xz
Source0  : https://download.kde.org/stable/release-service/24.02.2/src/killbots-24.02.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.02.2/src/killbots-24.02.2.tar.xz.sig
...
%setup -q -n killbots-24.02.2
cd %{_builddir}/killbots-24.02.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1712887916
mkdir -p clr-build
pushd clr-build
