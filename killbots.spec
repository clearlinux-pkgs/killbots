...
Version  : 24.08.1
Release  : 74
URL      : https://download.kde.org/stable/release-service/24.08.1/src/killbots-24.08.1.tar.xz
Source0  : https://download.kde.org/stable/release-service/24.08.1/src/killbots-24.08.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.08.1/src/killbots-24.08.1.tar.xz.sig
...
%setup -q -n killbots-24.08.1
cd %{_builddir}/killbots-24.08.1
pushd ..
cp -a killbots-24.08.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1726190013
mkdir -p clr-build
pushd clr-build
