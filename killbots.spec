...
Source0  : https://download.kde.org/stable/release-service/24.12.0/src/killbots-24.12.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.12.0/src/killbots-24.12.0.tar.xz.sig
...
%setup -q -n killbots-24.12.0
cd %{_builddir}/killbots-24.12.0
pushd ..
cp -a killbots-24.12.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1735228487
mkdir -p clr-build
pushd clr-build
