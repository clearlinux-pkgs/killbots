...
Version  : 22.08.3
Release  : 46
URL      : https://download.kde.org/stable/release-service/22.08.3/src/killbots-22.08.3.tar.xz
Source0  : https://download.kde.org/stable/release-service/22.08.3/src/killbots-22.08.3.tar.xz
Source1  : https://download.kde.org/stable/release-service/22.08.3/src/killbots-22.08.3.tar.xz.sig
...
%prep
%setup -q -n killbots-22.08.3
cd %{_builddir}/killbots-22.08.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1667880087
mkdir -p clr-build
pushd clr-build
