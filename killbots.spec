...
Source0  : https://download.kde.org/stable/release-service/23.04.1/src/killbots-23.04.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/23.04.1/src/killbots-23.04.1.tar.xz.sig
...
%prep
%setup -q -n killbots-23.04.1
cd %{_builddir}/killbots-23.04.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1685579873
mkdir -p clr-build
pushd clr-build
